...
<Heading sx={{"paddingTop": "90px", "paddingBottom": "40px", "fontWeight": "500"}}>{`Our Faith`}</Heading>
<Heading sx={{"fontSize": "1.1em", "fontWeight": "500"}}>{`We hold the faith which is common to all the believers (Titus 1:4, Jude 3):`}</Heading>
<Box sx={{"width": "55%"}}><Heading sx={{"fontSize": "1.35em", "fontWeight": "500"}}>{`The Bible`}</Heading>
...
<UnorderedList sx={{"paddingBottom": "15px"}}><ListItem>{`Christ is coming again to receive His believers to Himself (1 Thes. 2:19)`}</ListItem></UnorderedList></Box>
